  ...
  return (
    ...
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <p className="mx-auto mt-4 max-w-md text-center leading-relaxed text-gray-500">
        &copy; Copyright 2024 Malaika-Baig. All Rights Reserved.
      </p>
      ...
      <ul className="mt-8 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
        ...
        <li>
          <a className="text-gray-700 transition hover:text-gray-700/75" href="#skills"> Skills </a>
        </li>
        ...
        <li>
          <a className="text-gray-700 transition hover:text-gray-700/75" href="#reviews"> Reviews</a>
        </li>
      </ul>
